INSERT INTO USER_LIST (ID, USERNAME, SURNAME, EMAIL, USER_ROLE)
VALUES
    (1, 'Lix', 'test', 'test@gmail.com', 'test');

INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR)
VALUES
    (1, 'Solo Leveling', 'Chugong', 'Fantasy, Action',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR)
VALUES
    (2, 'Sword Art Online', 'Reki Kawahara, Shingo Adachi', 'Fantasy, Action, Drama',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR)
VALUES
    (3, 'That time I got reincarnated as a slime', 'Fuse, Mitz Vah', 'Fantasy, Isekai',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR)
VALUES
    (4, 'Violet Evergarden', 'Kana Akatsuki', 'Drama',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR)
VALUES
    (5, 'Darling in the Franxx', 'Kazuya Amano', 'Action, Drama, Romance',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR)
VALUES
    (6, '86', 'Haruto Umezawa', 'Action, Drama, Sci-Fi',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR)
VALUES
    (7, 'Mushoku Tensei: Jobless Reincarnation', 'Rifujin na Magonote', 'Fantasy, Isekai',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR)
VALUES
    (8, 'I have been killing slimes for 300 years and maxed out my level', 'Kisetsu Morita', 'Fantasy, Isekai',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR)
VALUES
    (9, 'The Strongest Sage with Weakest Crest', 'Shinkoshoto', 'Adventure, Fantasy',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR)
VALUES
    (10, 'Classroom of the Elite', 'Shogo Kinugasa', 'Thriller, Drama',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR)
VALUES
    (11, 'Tokyo Ghoul', 'Sui Ishida', 'Thriller, Fantasy',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR)
VALUES
    (12, 'Blue Lock', 'Muneyuki Kaneshiro', 'Sports, Thriller',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR)
VALUES
    (13, 'My unique Skill makes me OP even at level 1', 'Nazuna Miki', 'Fantasy, Isekai, Adventure',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR)
VALUES
    (14, 'The Rising of the Shield Hero', 'Aneko Yusagi', 'Action, Adventure, Fantasy',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR)
VALUES
    (15, 'The Promised Neverland', 'Kaiu Shirai', 'Mystery, Thriller, Fantasy',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR)
VALUES
    (16, 'In the Land of Leadale', 'Ceez', 'Adventure, Fantasy',
