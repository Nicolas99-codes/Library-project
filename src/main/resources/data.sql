...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, CATEGORY, DESCRIPTION, STATUS, RELEASE_YEAR, VIEWS)
VALUES
    (1, 'Solo Leveling', 'Chugong', 'Fantasy, Action', 'Manhwa',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, CATEGORY, DESCRIPTION, STATUS, RELEASE_YEAR, VIEWS)
VALUES
    (2, 'Sword Art Online', 'Reki Kawahara', 'Fantasy, Action, Drama', 'Light novel',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, CATEGORY, DESCRIPTION, STATUS, RELEASE_YEAR, VIEWS)
VALUES
    (3, 'That time I got reincarnated as a slime', 'Fuse', 'Fantasy, Isekai', 'Manga',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, CATEGORY, DESCRIPTION, STATUS, RELEASE_YEAR, VIEWS)
VALUES
    (4, 'Violet Evergarden', 'Kana Akatsuki', 'Drama', 'Manga',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, CATEGORY, DESCRIPTION, STATUS, RELEASE_YEAR, VIEWS)
VALUES
    (5, 'Darling in the Franxx', 'Atsushi Nishigori, Naotaka Hayashi', 'Action, Drama, Romance', 'Manga',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, CATEGORY, DESCRIPTION, STATUS, RELEASE_YEAR, VIEWS)
VALUES
    (6, '86', 'Haruto Umezawa', 'Action, Drama, Sci-Fi', 'Manga',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, CATEGORY, DESCRIPTION, STATUS, RELEASE_YEAR, VIEWS)
VALUES
    (7, 'Mushoku Tensei: Jobless Reincarnation', 'Rifujin na Magonote', 'Fantasy, Isekai', 'Light Novel',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, CATEGORY, DESCRIPTION, STATUS, RELEASE_YEAR, VIEWS)
VALUES
    (8, 'I have been killing slimes for 300 years and maxed out my level', 'Kisetsu Morita', 'Fantasy, Isekai', 'Manga',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, CATEGORY, DESCRIPTION, STATUS, RELEASE_YEAR, VIEWS)
VALUES
    (9, 'The Strongest Sage with Weakest Crest', 'Shinkoshoto', 'Adventure, Fantasy', 'Manga',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, CATEGORY, DESCRIPTION, STATUS, RELEASE_YEAR, VIEWS)
VALUES
    (10, 'Classroom of the Elite', 'Shogo Kinugasa', 'Thriller, Drama', 'Manga',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, CATEGORY, DESCRIPTION, STATUS, RELEASE_YEAR, VIEWS)
VALUES
    (11, 'Tokyo Ghoul', 'Sui Ishida', 'Thriller, Fantasy', 'Manga',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, CATEGORY, DESCRIPTION, STATUS, RELEASE_YEAR, VIEWS)
VALUES
    (12, 'Blue Lock', 'Muneyuki Kaneshiro', 'Sports, Thriller', 'Manga',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, CATEGORY, DESCRIPTION, STATUS, RELEASE_YEAR, VIEWS)
VALUES
    (13, 'My unique Skill makes me OP even at level 1', 'Nazuna Miki', 'Fantasy, Isekai, Adventure', 'Light Novel',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, CATEGORY, DESCRIPTION, STATUS, RELEASE_YEAR, VIEWS)
VALUES
    (14, 'The Rising of the Shield Hero', 'Aneko Yusagi', 'Action, Adventure, Fantasy', 'Light Novel',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, CATEGORY, DESCRIPTION, STATUS, RELEASE_YEAR, VIEWS)
VALUES
    (15, 'The Promised Neverland', 'Kaiu Shirai', 'Mystery, Thriller, Fantasy', 'Manga',
...
INSERT INTO BOOK (ID, TITLE, AUTHOR, GENRE, CATEGORY, DESCRIPTION, STATUS, RELEASE_YEAR, VIEWS)
VALUES
    (16, 'In the Land of Leadale', 'Ceez', 'Adventure, Fantasy', 'Manga',
