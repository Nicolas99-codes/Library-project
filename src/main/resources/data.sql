...
INSERT INTO BOOK (TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR, PRICE)
VALUES
    ('Solo Leveling', 'Chugong', 'Fantasy, Action',
...
INSERT INTO BOOK (TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR, PRICE)
VALUES
    ('Sword Art Online', 'Reki Kawahara', 'Fantasy, Action, Drama',
...
INSERT INTO BOOK (TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR, PRICE)
VALUES
    ('That time I got reincarnated as a slime', 'Fuse', 'Fantasy, Isekai',
...
INSERT INTO BOOK (TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR, PRICE)
VALUES
    ('Violet Evergarden', 'Kana Akatsuki', 'Drama',
...
INSERT INTO BOOK (TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR, PRICE)
VALUES
    ('Darling in the Franxx', 'Atsushi Nishigori, Naotaka Hayashi', 'Action, Drama, Romance',
...
INSERT INTO BOOK (TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR, PRICE)
VALUES
    ('86', 'Haruto Umezawa', 'Action, Drama, Sci-Fi',
...
INSERT INTO BOOK (TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR, PRICE)
VALUES
    ('Mushoku Tensei: Jobless Reincarnation', 'Rifujin na Magonote', 'Fantasy, Isekai',
...
INSERT INTO BOOK (TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR, PRICE)
VALUES
    ('I have been killing slimes for 300 years and maxed out my level', 'Kisetsu Morita', 'Fantasy, Isekai',
...
INSERT INTO BOOK (TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR, PRICE)
VALUES
    ('The Strongest Sage with Weakest Crest', 'Shinkoshoto', 'Adventure, Fantasy',
...
INSERT INTO BOOK (TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR, PRICE)
VALUES
    ('Classroom of the Elite', 'Shogo Kinugasa', 'Thriller, Drama',
     ...
     'The students are given a high degree of freedom in order to closely mimic real life.', 'Ongoing', 2016, 30);

INSERT INTO BOOK (TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR, PRICE)
VALUES
    ('Tokyo Ghoul', 'Sui Ishida', 'Thriller, Fantasy',
     ...
     'He is taken to the hospital in critical condition. After recovering, Kaneki discovers that he underwent a surgery that transformed him into a half-ghoul.', 'Completed', 2011, 30);

INSERT INTO BOOK (TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR, PRICE)
VALUES
    ('Blue Lock', 'Muneyuki Kaneshiro', 'Sports, Thriller',
     ...
     'His master plan to lead Japan to stardom is Blue lock, a training regimen designed to create the worlds greatest egotist striker.', 'Ongoing', 2018, 20);

INSERT INTO BOOK (TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR, PRICE)
VALUES
    ('My unique Skill makes me OP even at level 1', 'Nazuna Miki', 'Fantasy, Isekai, Adventure',
...
INSERT INTO BOOK (TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR, PRICE)
VALUES
    ('The Rising of the Shield Hero', 'Aneko Yusagi', 'Action, Adventure, Fantasy',
     ...
     'He discovers he is one of four heroes equipped with legendary weapons and tasked with saving the world from its prophesied destruction.', 'Ongoing', 2018, 20);

INSERT INTO BOOK (TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR, PRICE)
VALUES
    ('The Promised Neverland', 'Kaiu Shirai', 'Mystery, Thriller, Fantasy',
...
INSERT INTO BOOK (TITLE, AUTHOR, GENRE, DESCRIPTION, STATUS, RELEASE_YEAR, PRICE)
VALUES
    ('In the Land of Leadale', 'Ceez', 'Adventure, Fantasy',
...
INSERT INTO BOOK_CATEGORY (BOOKS_ID, CATEGORY_ID) VALUES (2, 2);
INSERT INTO BOOK_CATEGORY (BOOKS_ID, CATEGORY_ID) VALUES (3, 1);
INSERT INTO BOOK_CATEGORY (BOOKS_ID, CATEGORY_ID) VALUES (4, 1);
INSERT INTO BOOK_CATEGORY (BOOKS_ID, CATEGORY_ID) VALUES (5, 1);
INSERT INTO BOOK_CATEGORY (BOOKS_ID, CATEGORY_ID) VALUES (6, 1);
INSERT INTO BOOK_CATEGORY (BOOKS_ID, CATEGORY_ID) VALUES (7, 2);
INSERT INTO BOOK_CATEGORY (BOOKS_ID, CATEGORY_ID) VALUES (8, 1);
INSERT INTO BOOK_CATEGORY (BOOKS_ID, CATEGORY_ID) VALUES (9, 1);
INSERT INTO BOOK_CATEGORY (BOOKS_ID, CATEGORY_ID) VALUES (10, 1);
INSERT INTO BOOK_CATEGORY (BOOKS_ID, CATEGORY_ID) VALUES (11, 1);
INSERT INTO BOOK_CATEGORY (BOOKS_ID, CATEGORY_ID) VALUES (12, 1);
INSERT INTO BOOK_CATEGORY (BOOKS_ID, CATEGORY_ID) VALUES (13, 2);
INSERT INTO BOOK_CATEGORY (BOOKS_ID, CATEGORY_ID) VALUES (14, 2);
INSERT INTO BOOK_CATEGORY (BOOKS_ID, CATEGORY_ID) VALUES (15, 1);
INSERT INTO BOOK_CATEGORY (BOOKS_ID, CATEGORY_ID) VALUES (16, 1);
